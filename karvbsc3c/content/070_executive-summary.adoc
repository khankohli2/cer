...
////
Red Hat Consulting was engaged by Samsung Muzaffarpur to support the implementation of Red Hat OpenShift Container Platform {ocpversion} for the vBSC environment deployed on the Red Hat OpenShift Platform (RHOSP)
