...
image::OCP-4x-base/OpenShift_4_SDN-Pod to Service via Route via Ingress Router using Pod hostPort - Router, Source Pod, and Dest Pod Different Machine.png[]
...
image::OCP-4x-base/OpenShift_4_SDN-Pod to Service via Route via Ingress Router using Pod hostPort - Router Different Machine, Source Pod and Dest Pod Same Machine.png[]
...
image::OCP-4x-base/OpenShift_4_SDN-Pod to Service via Route via Ingress Router using Pod hostPort - Router and Source Pod Same Machine, Dest Pod Different Machine.png[]
...
image::OCP-4x-base/OpenShift_4_SDN-Ext Consumer Initiated to Service via Route via Ingress Router using Pod hostPort - Same Machine.png[]
...
image::OCP-4x-base/OpenShift_4_SDN-Ext Consumer Initiated to Service via Route via Ingress Router using Pod hostPort - Across Machines.png[]
...
image::OCP-4x-base/OpenShift_4_SDN-Ext Consumer Initiated to Service via Route via Ingress Router using Pod hostPort via Non-Default Subnet Interface - Same Machine.png[]
...
image::OCP-4x-base/OpenShift_4_SDN-Ext Consumer Initiated to Service via Route via Ingress Router using Pod hostPort via Non-Default Subnet Interface - Across Machines.png[]
...
image::OCP-4x-base/OpenShift_4_SDN-Ext Consumer Initiated to Service via Route via Ingress Router using Service nodePort - Same Machine.png[]
...
image::OCP-4x-base/OpenShift_4_SDN-Ext Consumer Initiated to Service via Route via Ingress Router using Service nodePort - Across Machines.png[]
